          ...
          <Container>
            ...
            <Navbar.Collapse id="navbar-header">
              <Nav className="me-auto">
                ...
                <NavDropdown title="Cachorros" id="basic-nav-dropdown">
                  ...
                  <NavDropdown
                    title="Tapetes, Fraldas e Banheiros"
                  ...
                  <NavDropdown
                    title="Coleiras, Guias e Peitorais"
                    id="basic-nav-dropdown"
                  >
                    <NavDropdown.Item
                      as={Link}
                  ...
                  <NavDropdown
                    title="Acessórios de Alimentação"
                    id="basic-nav-dropdown"
                  >
                    <NavDropdown.Item
                      as={Link}
                  ...
                  <NavDropdown
                    title="Acessórios de Transporte"
                    id="basic-nav-dropdown"
                  >
                    <NavDropdown.Item
                      as={Link}
                    ...
                    <NavDropdown.Item
                      ...
                      href="#action3.6"
                    >
                      Capas para Banco do Carro
                    </NavDropdown.Item>
                  </NavDropdown>
                  <NavDropdown
                    title="Portões, Grades e Escadas"
                    id="basic-nav-dropdown"
                  >
                    <NavDropdown.Item
                      as={Link}
                  ...
                  <NavDropdown
                    title="Adestramento e Comportamento"
                    id="basic-nav-dropdown"
                  >
                    <NavDropdown.Item
                      as={Link}
                ...
                <NavDropdown title="Gatos" id="basic-nav-dropdown">
                  ...
                  <NavDropdown
                    title="Arranhadores e Brinquedos"
                    id="basic-nav-dropdown"
                  >
                    <NavDropdown.Item
                      as={Link}
